    ...
    public partial class EmpReg : Form
    {
        ...
        public void insertar()
        {
            try
            {
                ...
                string consulta = "insert into Empleados (IDempleado,Nombre,Edad,Contraseña,Puesto) values (" + textBox1.Text + " ,\"" + textBox2.Text + "\",\"" + textBox3.Text + "\",\"" + textBox4.Text + "\",\"" + textBox5.Text+ "\");";
