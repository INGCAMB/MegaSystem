...
{
    public partial class ProdRegCon : Form
    {
        public ProdRegCon()
        {
            InitializeComponent();
        ...
        public void insertarproducto()
        {
            try
            {
                ...
                string consulta = "insert into Productos (Nombre,Precio,ID,Descripcion) values (\"" + textBox1.Text + "\",\"" + textBox2.Text + "\",\"" + textBox3.Text + "\",\"" + textBox4.Text + "\");";
        ...
        public void consultar()
        {
            try
            {
                ...
                string consulta = "select Nombre,Precio,ID,Descripcion from Productos";
                //Base de datos a conectar(preparar).
                OleDbConnection conexion = new OleDbConnection(cadena);
                //Consulta,conexion(prepara).
                OleDbCommand comando = new OleDbCommand(consulta, conexion);
